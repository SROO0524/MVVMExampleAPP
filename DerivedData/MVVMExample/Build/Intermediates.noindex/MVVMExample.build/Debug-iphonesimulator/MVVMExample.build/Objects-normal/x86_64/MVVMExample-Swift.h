...
#ifndef MVVMEXAMPLE_SWIFT_H
#define MVVMEXAMPLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MVVMExample",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11MVVMExample11AppDelegate")
...
SWIFT_CLASS("_TtC11MVVMExample27PersonFolloingTableViewCell")
@interface PersonFolloingTableViewCell : UITableViewCell
...
SWIFT_CLASS("_TtC11MVVMExample13SceneDelegate")
...
SWIFT_CLASS("_TtC11MVVMExample14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(MVVMExample)) <UITableViewDataSource, UITableViewDelegate>
